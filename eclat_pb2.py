...
_ECLAT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='FetchPackageConfiguration',
    full_name='Eclat.FetchPackageConfiguration',
    index=2,
    containing_service=None,
